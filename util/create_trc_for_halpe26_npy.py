...
def readTrc_header(path_to_trc, header_info=None, from_reference=False):
    ...
    if from_reference:
        ...
        num_of_markers = (
            header_info.num_of_markers
        )  # we only triangulate 22 of the 26 halpe joints
...
if __name__ == "__main__":
    ...
    argsp.add_argument(
        "--npy_path",
        default=r"C:\Users\Jeremias\Documents\Uni\HIWI_DFKI\Pose2SimPipeline\Pipeline\enhanced_3d_joints_with_weighted_feet_and_hip.npy",
        type=str,
        help="Path to the npy file",
    )
    argsp.add_argument(
        "--trc_path",
        default=r"C:\Users\Jeremias\anaconda3\envs\Pose2Sim\Lib\site-packages\Pose2Sim\RMTPoseL\RMTPoseL\ROM2\3c\23087_29092_29913\ROM2_RTMPose_0-3038_filt_butterworth.trc",
        type=str,
