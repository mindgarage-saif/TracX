...
if __name__ == "__main__":
    ...
    argsparser.add_argument(
        "--root_dir",
        default=r"E:\Uni\MonocularSystems\HiWi\experiments\Experiment_2024-09-17_20-33-36\pose\Generic Markerless 2_Miqus_6_28983_rot_json",
        type=str,
        help="Path to the directory containing the JSON files",
    )
    argsparser.add_argument(
        "--xml_path",
        default=r"E:\Uni\MonocularSystems\HiWi\Gait Markerless 2.settings_new.xml",
        type=str,
        help="Path to the camera XML file",
    )
    argsparser.add_argument(
        "--vid_path",
        default=r"E:\Uni\Data\LIHS\LIHS\ROM_2\ROM_2\Generic Markerless 2_Miqus_6_28983.avi",
        type=str,
