...
def theijsonTotrc( seq_name, f_range,json_path):
    with open(json_path, 'r') as file:
        data = json.load(file)
    frames = data['frames']
    Q_P = np.array([frame['segmentPos'] for frame in frames])[f_range[0]:f_range[1],:]
    ...
    keypoints_names=["RHip","RKnee","RAnkle","LHip","LKnee","LAnkle","Neck","RShoulder","RElbow","RWrist","LShoulder","LElbow","LWrist","Nose"]
    #Header
...
if __name__ == "__main__":
    ...
    argsparser.add_argument("--file_name",default='ROM_2', type=str, help="Sequence name")
    ...
    argsparser.add_argument("--json_path",default=r"E:\Uni\Data\LIHS\LIHS\ROM_2\ROM_2\Generic Markerless 2-3d-data.json", type=str, help="Path to the JSON file")
