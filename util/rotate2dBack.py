...
def rotate2dBack(baseDir, camera_parameters):
    ...
    for dir in listofDirs:
        ...
        json_files = [
            f for f in os.listdir(os.path.join(baseDir, dir)) if f.endswith(".json")
        ]
        ...
        for file in json_files:
            ...
            new_file = os.path.join(
                new_dir, f"{os.path.splitext(file)[0]}{os.path.splitext(file)[1]}"
            )
...
if __name__ == "__main__":
    ...
    argsparser.add_argument(
        "--baseDir",
        default=r"E:\Uni\MonocularSystems\HiWi\Data\experiments\new\LIHS\ROM2\pose",
        type=str,
        help="Base directory",
    )
    argsparser.add_argument(
